        ...
        public IActionResult ReportForm(string CodeForm)
        {
            ...
            var ModelPA = _db.PowerOfAttorneys.Where(s => s.CodeForm == CodeForm)
                .Select(s => new
                {
                    ...
                    AttorneyLocation = s.User_AttorneyID.Company.CompanyAddress ?? s.User_AttorneyID.Address,
                    AttorneyLocationEg = s.User_AttorneyID.Company.CompanyAddressEg ?? s.User_AttorneyID.AddressEg,
