...
namespace WorkPermitManager.Data
{
    ...
    public partial class Db_WorkPermitManagerModel : DbContext
    {
        ...
        private void EmployerAuthorizationConfigMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<EmployerAuthorizationConfig>().Property(x => x.Witness1).HasColumnName(@"Witness1").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<EmployerAuthorizationConfig>().Property(x => x.Witness2).HasColumnName(@"Witness2").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<EmployerAuthorizationConfig>().Property(x => x.AssignorName).HasColumnName(@"AssignorName").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
            modelBuilder.Entity<EmployerAuthorizationConfig>().Property(x => x.AssignorCompany).HasColumnName(@"AssignorCompany").HasColumnType(@"nvarchar(255)").ValueGeneratedNever().HasMaxLength(255);
